...
<body>
	...
	<form action = "ex4_process02.jsp" method = "POST">
		...
		<label for = "gedner2">여성</label>		
		<input type ="radio" id = "gedner2" name = "gender" value = "female" > 
		</p>
		...
		<p>취미 : 독서<input type = "checkbox" value="독서" name="hobby1">
		운동<input type = "checkbox" value="운동" name="hobby2">
		영화<input type = "checkbox" value="영화" name="hobby3">
		</p>
